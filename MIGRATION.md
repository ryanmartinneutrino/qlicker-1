...
- ✅ Additional student/practice question-library polish — instructor-facing question editors now explain when course-topic tags are required and disabled until course topics exist; student libraries hide edit/response-management affordances for questions they cannot manage; practice-session editors now expose insert slots before, between, and after questions plus bottom-of-modal actions for adding selected or random library questions; and “Save and start practice” now opens the practice-session review screen directly
